...
node bin/pilot.mjs --game ashfall --model claude-sonnet-5 --prompt prompts/ashfall/game32-sonnet.md --ashfall-search-fields true --stop-file /tmp/qd-stop   # live (full working config in HANDOFF.md)
