...
| games 16-19 | M7 packet ablation: game 16 `--full-every 5` packet 467, loss; games 17-19 `--full-every 5 --ashfall-fold-fields true --ashfall-full-buildings true` packet 427/415/508, three wins, reaction p50 3.9-4.0 s. `--ashfall-fields-on-demand` built for game 20. `notes/ashfall/games.md` |
