...
| M7 iterate | in progress (games 13-25, 2026-09-12): packet ablation done, decision bench and trajectory replay built, order language adopted (output 101 → 48 tokens, reaction p50 5.6 → 3.7 s); see `HANDOFF.md` |
